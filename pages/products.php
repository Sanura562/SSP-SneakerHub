    ...
    <div class="container mx-auto py-6 px-4">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-lg p-4 shadow flex flex-col items-center">
                <img src="https://via.placeholder.com/200" alt="Air Jordan 1 Mid" class="rounded-md mb-4">
            ...
            <!-- Product 2 -->
            <div class="bg-white rounded-lg p-4 shadow flex flex-col items-center">
                <img src="https://via.placeholder.com/200" alt="Nike Air Force 1 High" class="rounded-md mb-4">
            ...
            <!-- Product 3 -->
            <div class="bg-white rounded-lg p-4 shadow flex flex-col items-center">
                <img src="https://via.placeholder.com/200" alt="Nike Free Metcon 6" class="rounded-md mb-4">
            ...
            <!-- Product 4 -->
            <div class="bg-white rounded-lg p-4 shadow flex flex-col items-center">
                <img src="https://via.placeholder.com/200" alt="KD17 'Aunt Pearl'" class="rounded-md mb-4">
            ...
            <!-- Product 5 -->
            <div class="bg-white rounded-lg p-4 shadow flex flex-col items-center">
                <img src="https://via.placeholder.com/200" alt="Nike Free Run 2018" class="rounded-md mb-4">
